...
public class DBS_Sim_Thread {

  public static void main(String[] args) {
    
	  HelloWorldSwing te = new HelloWorldSwing();
	  HelloWorldSwing nte = new HelloWorldSwing();
	  
	  int th;
	  
	  th=0;
	  /*
	  nte.createAndShowGUI();
	  th = te.createAndShowGUI();
