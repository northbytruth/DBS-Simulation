...
/** Model exported on Jan 19 2014, 22:42 by COMSOL 4.3.2.152. */
public class javaExtract {
  ...
  public static Model run() {
	...
	BELOW IS THE POTENTIAL SETTING!!!
	...
	*/
    ...
    model.name("32ElectrodeModelRefined.mph");
    ...
    model.result("pg2").run();
    model.result("pg2").run();
    model.result("pg2").feature().create("poma1", "PoincareMap");
    model.result("pg2").feature().remove("poma1");
    model.result("pg2").run();
    model.result("pg2").run();
    model.result("pg2").run();
    model.result("pg2").feature().create("traj1", "ParticleTrajectories");
    model.result("pg2").feature().remove("traj1");
    model.result("pg2").run();
    model.result("pg2").feature().create("arwv1", "ArrowVolume");
    model.result("pg2").run();
    ...
    model.result("pg2").run();
    model.result("pg2").run();
    model.result("pg2").feature("arwv1").active(true);
    model.result("pg2").run();
    model.result("pg2").run();
    model.result("pg2").feature().create("con1", "Contour");
    model.result("pg2").run();
    ...
    model.result("pg2").feature("arwv1").set("arrowbase", "head");
    model.result("pg2").feature("arwv1").set("arrowlength", "normalized");
